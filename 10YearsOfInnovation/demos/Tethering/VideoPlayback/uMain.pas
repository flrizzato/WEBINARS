...
uses
  ...
  System.Actions, FMX.ActnList, IPPeerClient, IPPeerServer,
...
begin
  if fSelected < ListBox1.Items.Count - 1 then
  begin
    Inc(fSelected);
    ListBox1.ItemIndex := fSelected;
    ListBox1.ScrollToItem(ListBox1.Selected);
    ListBox1.ViewportPosition :=
      PointF(0.0, ListBox1.ItemIndex * ListBox1.ItemHeight);
  end;
end;
...
begin
  MediaPlayer1.FileName := TPath.Combine(FLibraryPath, ListBox1.Selected.Text);
  MediaPlayer1.Play;
end;
