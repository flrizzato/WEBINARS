...
{$METHODINFO ON}
  TServerMethods1 = class(TDataModule)
    ...
    CaseTableIsDeleted: TBooleanField;
    ...
    CaseTableDescription: TWideMemoField;
    CaseTableIsClosed: TBooleanField;
    CaseTableClosedDate: TSQLTimeStampField;
    CaseTableIsEscalated: TBooleanField;
    CaseTableOwnerId: TWideStringField;
    CaseTableCreatedDate: TSQLTimeStampField;
    CaseTableCreatedById: TWideStringField;
    CaseTableLastModifiedDate: TSQLTimeStampField;
    CaseTableLastModifiedById: TWideStringField;
    CaseTableSystemModstamp: TSQLTimeStampField;
    ...
    CaseTableLastViewedDate: TSQLTimeStampField;
    CaseTableLastReferencedDate: TSQLTimeStampField;
  private
