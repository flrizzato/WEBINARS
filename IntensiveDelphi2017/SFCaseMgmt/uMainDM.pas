...
type
  TMainDM = class(TDataModule)
    ...
    CaseMemTableIsDeleted: TBooleanField;
    ...
    CaseMemTableDescription: TWideMemoField;
    CaseMemTableIsClosed: TBooleanField;
    CaseMemTableClosedDate: TSQLTimeStampField;
    CaseMemTableIsEscalated: TBooleanField;
    CaseMemTableOwnerId: TWideStringField;
    CaseMemTableCreatedDate: TSQLTimeStampField;
    CaseMemTableCreatedById: TWideStringField;
    CaseMemTableLastModifiedDate: TSQLTimeStampField;
    CaseMemTableLastModifiedById: TWideStringField;
    CaseMemTableSystemModstamp: TSQLTimeStampField;
    ...
    CaseMemTableLastViewedDate: TSQLTimeStampField;
    CaseMemTableLastReferencedDate: TSQLTimeStampField;
